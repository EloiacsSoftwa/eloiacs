...
const CustomerDetails = (props) => {
  ...
  useEffect(() => {
    if (props.customers.code === SUCCESS_CODE_NO) {
  ...
  const saveAddress = () => {
    ...
    if (
      ...
      (!formData.addressLine1.trim() && !formData.addressTypeId) ||
        ...
        <>
          ...
          >
            ...
            <Modal.Footer>
              ...
              <Button className="border-0" type="reset" variant="primary" onClick={saveBankDetails} style={{ backgroundColor: '#1d1d5e', height: 'max-content', width: 'max-content' }}>
                Save
              </Button>
            </Modal.Footer>
          </Modal>
              ...
              <Form>
                {["radio"].map((type) => (
                  ...
                  >
                    ...
                    {addressTypeError && (
                      <p style={{ color: "red" }}>Address type is required</p>
                    )}
                  </FormGroup>
                ))}
              </Form>
